...
class MKReportBase() {
  ...
  def writeFile(outDF: DataFrame, metricName: String, columsHead: String) {
    val outputfileLoc = "hdfs://zdwttda10.ebiz.verizon.com:8020/user/sfdcuser/MKmetrics/out/metrics/"
  ...
  def createheaderFile(column:String) {
    val path = new Path("hdfs://zdwttda10.ebiz.verizon.com:8020/user/sfdcuser/MKmetrics/out/metrics/Inter/columnhead")
  ...
  def merge(metricName: String, columsHead: String): Unit = {
    try {
      ...
      //val outputfileLoc = "C:/ac/TestData/scala/out/metrics/"
      val outFileName = outputfileLoc + metricName
      val outLoc = "hdfs://zdwttda10.ebiz.verizon.com:8020/user/sfdcuser/MKmetrics/out/"
